...
public final class JpGoiMon extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        lblTenBan.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        ...
        btnthugon.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        btnthugon.setText("Trở về");
        btnthugon.setPreferredSize(new java.awt.Dimension(120, 40));
        ...
        btndatban.setPreferredSize(new java.awt.Dimension(120, 40));
        ...
        btngoi.setPreferredSize(new java.awt.Dimension(120, 40));
        ...
        jpThongTinBanLayout.setHorizontalGroup(
            ...
            .addGroup(jpThongTinBanLayout.createSequentialGroup()
                ...
                .addGroup(jpThongTinBanLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(btnthugon, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        ...
        jpThongTinBanLayout.setVerticalGroup(
            ...
            .addGroup(jpThongTinBanLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jpThongTinThanhToan, javax.swing.GroupLayout.PREFERRED_SIZE, 88, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(btnthugon, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(31, 31, 31))
        );
    ...
    public void fillDsMon(int mahd){
        ...
        if(order != null){
            ...
            for(int i=0;i<order.size();i++){
                ...
                pn[i].setBackground(Color.decode("#66b3ff"));
                ...
                pn[i].add(new JLabel(String.valueOf(chuyentien.format(order.get(i).GetGia()))+" VNĐ",JLabel.CENTER)).setForeground(Color.decode("#ffffff"));
                pn[i].add(new JLabel(String.valueOf(order.get(i).GetSoLuong())+" "+ order.get(i).GetDVT(),JLabel.RIGHT)).setForeground(Color.decode("#000000"));
                Icon ic = new ImageIcon("src/Icons/DeleteRed.png");
                JLabel lbl = new JLabel("", ic,JLabel.CENTER);
                lbl.setForeground(Color.decode("#66ff33"));
    ...
    private void btngoiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btngoiActionPerformed
        ...
        if(btngoi.getText().equals("Hủy bàn")){
            ...
            DLThanhToan thanhtoan = new DLThanhToan(Run.QlCafe, true, tongtien, TenBan, MaBan, MaHD);//tổng tiền trạng thái tên bàn
